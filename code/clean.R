...
# 
# # TODO Clean up columns [x] means done [ ] means still left, [-] means decided not also there could be more 
# # that is just what i observed
# 
...
# #                   [x] NOTE: Does SW go with other or with white? 
# #                       - it went with other.
# 
# 
...
#   x = reorder(color, price),
#   y = price,
#   fill = color
# )) + geom_boxplot() +
#   xlab("Color") + theme_clean() + scale_y_log10() #+ theme(legend.position = "none") 
# 
